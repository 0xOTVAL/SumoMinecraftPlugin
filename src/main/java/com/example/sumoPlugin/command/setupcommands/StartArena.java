...
public class StartArena extends SubCommand {
    Sumo plugin;
    public StartArena(Sumo plugin){
        this.plugin=plugin;
    }
    @Override
    public void runCommand(CommandSender sender, Command baseCommand, String baseCommandLabel, String subCommandLabel, String[] subCommandArgs) {
        ...
        sender.sendMessage(arena.start());
    }
    @Override
    public boolean canExecute(CommandSender sender, Command baseCommand, String baseCommandLabel, String subCommandLabel, String[] subCommandArgs) {
        ...
        return (subCommandLabel.equals("arena") && subCommandArgs[1].equals("start"));
    }
}
